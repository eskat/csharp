...
namespace SdetBootcampDay2.Exercises
{
    ...
    public class Exercises02
    {
        ...
        public void MockPaymentProcessor_ReturnFalseForAllStripePayments()
        {
            ...
            /**
             * DONE: Create a mock object representing the payment processor. Pass in Stripe
            ...
            /**
             * DONE: Complete the test by creating a new OrderHandler, passing in the mock object
            ...
            /**
             * DONE: verify that the PayFor() method of the mock payment processor was called
