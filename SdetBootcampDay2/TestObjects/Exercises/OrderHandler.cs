namespace SdetBootcampDay2.TestObjects.Exercises
{
    public class OrderHandler
    {
        ...
        /**
         * DONE: can you apply Dependency Inversion here to make this code more flexible,
         ...
         * not possible before.
         */
        public OrderHandler(IDictionary<OrderItem, int>? stock, PaymentProcessor paymentProcessor)
        {
            this.stock=stock;
        ...
        /**
         * DONE: this method clearly violates the Single Responsibility Principle
