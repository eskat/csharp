...
namespace SdetBootcampDay3.Exercises
{
    ...
    public class Exercises01
    {
        ...
        public async Task GetDataForUser1_CheckStatusCode_ShouldBeHttpOK()
        {
            ...
            /**
             * DONE: Assert that the response status code is equal to HttpStatusCode.OK
             */
        ...
        public async Task GetDataForUser1_CheckStatusCode_ShouldBeHttp200()
        {
            ...
            /**
             * DONE: Assert that the response status code is equal to 200 (integer)
             */
        ...
        {
            /**
             * DONE: Create and execute a new GET request to 'users/2'
        ...
        {
            /**
             * DONE: Create and execute a new GET request to '/users/3'
        ...
        public async Task GetDataForUser5_CheckCompanyName_ShouldBeKeeblerLLC()
        {
             ...
             */
            string expectedCompanyName = "Keebler LLC";
            ...
            //give value of joke element and get as a string, then compare to expected 
            Assert.That(responseData.SelectToken("company.name")!.ToString(), Is.EqualTo(expectedCompanyName));
        }
    }
}
